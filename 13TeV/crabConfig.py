...
def submission():
    ...
    config.General.workArea = '/nfs/dust/cms/user/gsieber/crab_kappa_skim-2015-11-27_13TEV'
    ...
    config.Data.outLFNDirBase = '/store/user/sieber/SKIMS_JETS_2015/2015-11-27_13TEV'
